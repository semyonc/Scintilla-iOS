...
int CallTip::PaintContents(Surface *surfaceWindow, bool draw) {
	...
	while (moreChunks) {
		...
		long chunkOffset = chunkVal - val.c_str();
		long chunkLength = chunkEnd - chunkVal;
		long chunkEndOffset = chunkOffset + chunkLength;
		int thisStartHighlight = Platform::Maximum(startHighlight, (int)chunkOffset);
		thisStartHighlight = Platform::Minimum(thisStartHighlight, (int)chunkEndOffset);
		thisStartHighlight -= chunkOffset;
		int thisEndHighlight = Platform::Maximum(endHighlight, (int)chunkOffset);
		thisEndHighlight = Platform::Minimum(thisEndHighlight, (int)chunkEndOffset);
		...
		DrawChunk(surfaceWindow, x, chunkVal, thisEndHighlight, (int)chunkLength,
			ytext, rcClient, false, draw);
